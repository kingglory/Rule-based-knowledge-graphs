...
class MedicalGraph:
    def __init__(self):
        ...
        #     password="icqmsbest104")
        self.g = Graph("http://localhost:7474", auth=("neo4j", "icqmsbest104"))
    '''读取文件'''
    def read_nodes(self):
        # 共７类节点
        drugs = [] # 药品
        ...
        for data in open(self.data_path, encoding='utf-8'):
            ...
            if 'cure_department' in data_json:
                ...
                if len(cure_department) == 2:
                    ...
                    rels_department.append([small, big])# 相关科室
    ...
    def create_relationship(self, start_node, end_node, edges, rel_type, rel_name):
        ...
        for edge in set(set_edges):
            ...
            # https://blog.csdn.net/weixin_40959890/article/details/127042222 # Cypher 基础语法
            try:
                self.g.run(query)
                count += 1
