...
class QuestionClassifier:
    def __init__(self):
        ...
        self.department_path = os.path.join(cur_dir, 'dict/department.txt')#门诊
        ...
        self.belong_qwds = ['属于什么科', '属于', '什么科', '科室','挂什么号']
        self.cure_qwds = ['治疗什么', '治啥', '治疗啥', '医治啥', '治愈啥', '主治啥', '主治什么', '有什么用', '有何用', '用处', '用途',
                          '有什么好处', '有什么益处', '有何益处', '用来', '用来做啥', '用来作甚', '需要', '要','怎么办']
    ...
    def check_medical(self, question):
        ...
        # 识别停用词，如果长字符串包含短字符串，则短字符串视为停用词，比如：“阿司匹林胶囊”“阿司匹林”
        # 默认长字符串为 有效问题 关键词
        stop_wds = []
        for wd1 in region_wds:
            for wd2 in region_wds:
                if wd1 in wd2 and wd1 != wd2:
                    stop_wds.append(wd1)
        final_wds = [i for i in region_wds if i not in stop_wds]# 去除停用词
        final_dict = {i:self.wdtype_dict.get(i) for i in final_wds}# 根据 关键词 提取实体类别，比如是病因还是治疗方法等
